...
def run_trial(switch_doors, ndoors=3):
    """
    Run a single trial of the Monty Hall problem, with
    after the game show host reveals a goat behind one
    (switch_doors is True or False). The car is behind
    game show host knows that. Returns True for a win,
    or without switching
    of the unchosen doors.
    door number 1 and the
