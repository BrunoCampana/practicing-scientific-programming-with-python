...
class Polymer:
    ...
    def make_polymer(self):
        """
        Calculate the segment positions, center of mass and end-to-end distance for a random-flight polymer.
        """
    ...
    def calc_Rg(self):
        """
        Calculates and returns the radius of gyration, Rg. The polymer segment positions are already given relative to the center of mass, so this is just the rms position of the segments.
        """
        self.Rg = 0.
